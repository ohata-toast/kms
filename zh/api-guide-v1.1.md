...
## Security > Secure Key Manager > API v1.1 Guide
...
| GET | /keymanager/v1.1/appkey/{appkey}/asymmetric-keys/{keyid}/privateKey | Query the private key stored in Secure Key Manager. |
